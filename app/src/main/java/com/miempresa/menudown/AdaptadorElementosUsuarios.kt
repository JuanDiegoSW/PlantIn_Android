...
class AdaptadorElementosUsuarios(val ListaElementos:ArrayList<Usuarios>): RecyclerView.Adapter<AdaptadorElementosUsuarios.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent?.context).inflate(R.layout.elementoslistausuario, parent, false);
        return ViewHolder(v);
    }
}
